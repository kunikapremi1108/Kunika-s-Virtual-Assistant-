...
function Home() {
  ...
  return (
<div className="w-full min-h-[100dvh] bg-gradient-to-br from-gray-900 to-blue-900 flex flex-col lg:flex-row">
      {/* Sidebar */}
      <aside className="lg:w-80 w-full  h-auto bg-black/30 backdrop-blur-xl border-r border-white/30 flex flex-col p-4 lg:p-6">
        {/* Assistant Info */}
        ...
        <div className="flex-1 overflow-y-auto p-4 lg:p-6 space-y-4">
          {messages.length === 0 ? (
            ...
            messages.map((msg, index) => (
              ...
              >
                <div
                  className={`max-w-full sm:max-w-xs lg:max-w-md px-3 sm:px-4 py-2 sm:py-3 rounded-xl shadow-md ${msg.type === "user"
